...
function InventoryLoginPage() {
  ...
  const handleAdminLogin = () => {
    if (username === 'inventory' && password === 'inventory@123') {
      navigate('/Home');
    } else {
  ...
  const handleUserLoginClick = () => navigate('/login');
  ...
  return (
    <div style={containerStyle}>
      <div style={loginCardStyle}>
        ...
        <h2 style={titleStyle}>Inventory Manager Login</h2>
